...
def extract_data_with_ai(fp_text, wb_text, api_key):
    """Envoie le texte brut à l'IA Gemini avec sélection dynamique du modèle."""
    genai.configure(api_key=api_key)
    
    try:
        # 1. Sélection dynamique du modèle autorisé pour votre clé
        ...
        # On cherche prioritairement la version 1.5 Flash, sinon on prend le premier disponible
        ...
        st.error(f"Erreur de l'IA ({model_name}) : {str(e)}")
        return None
# ==========================================
